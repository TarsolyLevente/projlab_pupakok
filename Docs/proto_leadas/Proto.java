...
public class Proto {
            ...
            if (szoba1.getid().equals(s2)) {
                ...
                for (Takarito takarito : palya.getTakaritok()) {
                    if (takarito.getid().equals(s1)) {
                        ...
                        if (szoba1.getTakaritok().contains(takarito) && szoba1.getTakaritok().size() == 1
                                && szoba1.getHallgatok().size() == 0 && szoba1.getOktatok().size() == 0
                                && szoba1.isRagacsos() == false && szoba1.isGazos() == false)
                            return "Karakter mozgása sikeres.";
                        else
                            return "Karakter mozgása sikertelen.";
                    }
    ...
    private String leptet() {
        ...
        palya.general();
        palya.leptet();
        if (palya.getOktatok().get(0).getSzoba().getSzomszedok().get(0).getid().equals("43")
                && palya.getTakaritok().get(0).getSzoba().getSzomszedok().get(0).getid().equals("26"))
